...
declare function setFlag<T>(doc: FoundryDocument, ...args: [...string[], T]): Promise<FoundryDocument<any>>;
...
declare function getFlagProperty<T>(obj: object, ...args: string[]): T | undefined;
...
export { flagPath, getFlag, getModuleFlag, getFlagProperty, hasModuleFlag, setFlag, setFlagProperty, unsetFlag, unsetMofuleFlag, updateFlag, };
